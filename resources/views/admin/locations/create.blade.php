...
@section('pageName', 'Добавление населённые пункта')

@section('breadcrumbs')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.locations.index') }}">Населённые пункты</a>
    </li>
    <li class="breadcrumb-item active" aria-current="page">Добавление населённые пункта</li>
@endsection
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('admin.locations.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
