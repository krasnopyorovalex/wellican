...
@section('pageName', 'Список меток')

@section('breadcrumbs')
    <li class="breadcrumb-item active" aria-current="page">Список меток</li>
@endsection
    ...
    <section class="section">
        <div class="row">
            <div class="col-12 mb-2">
                <a href="{{ route('admin.object-labels.create') }}" class="btn icon icon-left btn-primary">
                    Добавить
                </a>
            </div>
                    ...
                    <div class="card-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                @foreach($objectLabels as $objectLabel)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a href="{{ route('admin.object-labels.edit', $objectLabel) }}"
                                            ...
                                            <form method="post"
                                                  action="{{ route('admin.object-labels.destroy', $objectLabel) }}"
