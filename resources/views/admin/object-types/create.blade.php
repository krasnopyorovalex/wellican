...
@section('pageName', 'Добавление типа недвижимости')

@section('breadcrumbs')
    <li class="breadcrumb-item">
        <a href="{{ route('admin.object-types.index') }}">Типы недвижимости</a>
    </li>
    <li class="breadcrumb-item active" aria-current="page">Добавление типа недвижимости</li>
@endsection
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form" method="post" action="{{ route('admin.object-types.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
